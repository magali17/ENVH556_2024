...
* This template is designed as an example for structuring your lab reports. It provides a resource to support your work but is **entirely optional and not the only acceptable format for lab report submissions**.
...
* Before using this template, delete: 
  ...
  * things in brackets 
  * irrelevant text
* This document provides suggested paragraph lengths for each section. Academic paragraphs are roughly 100-300 words, but use your judgment — developing scientific judgment is a key goal of this class.
