...
* This template serves as an example for structuring your lab reports. It is not the only approach for completing assignments successfully.    
* Refer to the 'Lab Report Guidelines.html' document for detailed requirements on structuring and formatting each section.    
* Make sure to add comments to your code to aid in transparancy and future replication   
...
[Describe the steps you took to conduct the analysis. Specify each procedure, providing enough information for someone to replicate your work accurately.]
