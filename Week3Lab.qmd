...
These data are described in the [Mercer et al, 2011](https://doi.org/10.1016/j.atmosenv.2011.05.043).  
...
snap2 %>% 
  dplyr::select(ID, SeasonID = seasonfac, ln_nox, preds_sum, resids_sum, preds_fall,
