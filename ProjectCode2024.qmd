...
data_path <- file.path("..", "data", "mobile monitoring", "original")
...
annual <- read.csv(file.path(data_path, "annual_data_and_predictions.csv"))

mm_covariates <- read.csv(file.path(data_path, "covariates", "dr0311_mobile_covars.csv"))
