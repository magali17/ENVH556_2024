...
calculate_mse_r2 <- function(observed, predicted) {
  ...
  ## NOTE: var() calculates the sample variance, which divides by n-1 (vs n). 
  ## An alternative is to, use: mean((observed - mean(observed))^2), which estimates a population-level variance that may be biased
