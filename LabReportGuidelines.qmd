...
author: "ENVH 556 Winter 2024 Instructors"
format:
  html:
    df_print: "paged"
    fig_caption: yes
...
You may compile your Markdown file into a word, pdf, or html file, but we suggest `.html` files as they are the easiest to format and render. The [HTML Chapter](https://bookdown.org/yihui/rmarkdown/html-document.html) of ["R Markdown: The Definitive Guide"](https://bookdown.org/yihui/rmarkdown/) is a helpful resource.

## Drafting your report {-}
Writing drafts of the introduction, data, and methods sections before the data analysis begins can be very useful in guiding your analysis and *save time*. A surprisingly large amount of the report can be written before the detailed analysis has begun. While drafting your lab report you can render a `.qmd` with the `eval = FALSE` option to prevent the code from being run before you are ready.
...
1. In general you should finalize your code like you finalize your scientific writing:  It should be clear, concise, and nicely formatted. Incorporate the following **formatting strategies** into your code in your assignments:
    ...
    A. *Be clear about what each chunk does.* You can do this by 1) giving chunks descriptive names/header comments and 2) commenting the body of a chunk.  See examples in the course Markdown files.
...
While not required for class, there are tools to integrate reference manager libraries (e.g., [Zotero](https://www.zotero.org/)) into `.qmd` files. Quarto’s instructions for [bibliographies and citations](https://quarto.org/docs/authoring/citations.html) will help you get started with integrating your reference manager into your lab reports.
