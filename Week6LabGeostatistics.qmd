...
pacman::p_load(
    ...
    # maptiles and tmap libraries can be used instead of or in combination with ggplot and ggspatial. maptiles offers more tile-based map flexibility; ggspatial provides the ability to annotate maps easily; tmap offers both static and interactive maps
...
new_grid <- new_grid %>% mutate(NOx = var1.pred)
